...
//     // Use the computed styles to get the width of the container element
//     var containerStyle = window.getComputedStyle(element.parentElement);
//     var containerWidth = parseInt(containerStyle.width);

//     // Calculate the new height based on the video aspect ratio
//     var aspectRatio = element.videoWidth / element.videoHeight;
//     var newHeight = containerWidth / aspectRatio;

//     // Set the new width and height of the video and canvas
//     videoMerge.width = containerWidth;
//     videoMerge.height = newHeight;
